...
struct API {
    ...
    static let containerFlesh = "open-ils.actor.container.flesh"
    static let containerItemCreate = "open-ils.actor.container.item.create"
    static let containerItemDelete = "open-ils.actor.container.item.delete"
    static let containerRetrieveByClass = "open-ils.actor.container.retrieve_by_class.authoritative"
    static let containerTypeBookbag = "bookbag"
    ...
    static let userSettingKeepCheckoutHistory = "history.circ.retention_start"
